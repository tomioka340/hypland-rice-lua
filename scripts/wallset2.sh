...
cp ~/wallpapers-volume-2/*.jpg ~/CURRENT_WALLS/
...
sed -i '/ALT + 4/s/source-color-index [0-9]/source-color-index 2/' "$CONFIG"
sed -i '/ALT + 5/s/source-color-index [0-9]/source-color-index 0/' "$CONFIG"
sed -i '/ALT + 6/s/source-color-index [0-9]/source-color-index 3/' "$CONFIG"
sed -i '/ALT + 7/s/source-color-index [0-9]/source-color-index 2/' "$CONFIG"
sed -i '/ALT + 8/s/source-color-index [0-9]/source-color-index 1/' "$CONFIG"
...
sed -i '/CTRL + 9/s/source-color-index [0-9]/source-color-index 2/' "$CONFIG"

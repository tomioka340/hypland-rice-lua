...
cp ~/wallpapers-volume-3/*.jpg ~/CURRENT_WALLS/


sed -i '/ALT + 1/s/source-color-index [0-9]/source-color-index 2/' "$CONFIG"
...
sed -i '/ALT + 7/s/source-color-index [0-9]/source-color-index 1/' "$CONFIG"

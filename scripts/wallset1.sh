...
cp ~/wallpapers-volume-1/*.jpg ~/CURRENT_WALLS/


sed -i '/ALT + 1/s/source-color-index [0-9]/source-color-index 0/' "$CONFIG"
sed -i '/ALT + 2/s/source-color-index [0-9]/source-color-index 2/' "$CONFIG"
...
sed -i '/ALT + 5/s/source-color-index [0-9]/source-color-index 1/' "$CONFIG"
sed -i '/ALT + 6/s/source-color-index [0-9]/source-color-index 1/' "$CONFIG"
sed -i '/ALT + 7/s/source-color-index [0-9]/source-color-index 2/' "$CONFIG"
sed -i '/ALT + 8/s/source-color-index [0-9]/source-color-index 0/' "$CONFIG"
sed -i '/ALT + 9/s/source-color-index [0-9]/source-color-index 1/' "$CONFIG"
...
sed -i '/CTRL + 6/s/source-color-index [0-9]/source-color-index 1/' "$CONFIG"
...
awww img ~/CURRENT_WALLS/wall1.jpg --transition-type wave
exec ~/.config/waybar/scripts/waybar1.sh
